...
- 協作契約（不可退化守則）：[AGENTS.md](file:///Users/bytedance/Desktop/Ludwig/Vellichor/AGENTS.md)
- 專案文件索引（只更新受影響文件）：[docs/doc-map.md](file:///Users/bytedance/Desktop/Ludwig/Vellichor/docs/doc-map.md)
- 操作手冊（一步一步）：`skills/`
